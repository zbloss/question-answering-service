...
class TestWineItem:
    ...
    example_wine_object_with_no_regions: dict = {
        "points": "87",
        "title": "Nicosia 2013 Vulkà Bianco  (Etna)",
        "description": "Aromas include tropical fruit, broom, brimstone and dried herb. The palate isn't overly expressive, offering unripened apple, citrus and dried sage alongside brisk acidity.",
        "taster_name": "Kerin O’Keefe",
    ...
    def test_wine_no_regions(self):
        wine_item = WineItem(**self.example_wine_object_with_no_regions)
        expected_region = "No available region"

        assert (
            wine_item.region == expected_region
        ), f"wine_item.region ({wine_item.region}) was created as expected."
